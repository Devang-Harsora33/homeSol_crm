...
REPORT_FILE = "channel_partners_api_test_report.csv"
MODULE_NAME = "Channel Partners"
...
def randomize_value(key, value):
    ...
    if "email" in key.lower():
        return f"cp_test_{timestamp}_{random.randint(100, 999)}@example.com"
    if any(k in key.lower() for k in ["mobile", "phone", "whatsapp"]):
        return f"9{random.randint(100000000, 999999999)}"
    if "rera_number" in key.lower():
        return f"RERA{timestamp}{random.randint(100,999)}"
...
# =================================================================
# 3. CHANNEL PARTNERS TESTING LOGIC
# =================================================================
