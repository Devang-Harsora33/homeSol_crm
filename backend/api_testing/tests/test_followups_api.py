...
REPORT_FILE = "followups_api_test_report.csv"
...
def randomize_value(key, value):
    ...
    if "email" in key.lower():
        return f"followup_test_{timestamp}_{random.randint(100, 999)}@example.com"
...
# =================================================================
# 3. FOLLOW-UPS TESTING LOGIC
# =================================================================

def run_tests():
    print(f"🎯 Starting FOLLOW-UPS Module Testing")
    ...
    all_requests = extract_module_requests(collection["item"], "Follow ups")
    ...
    print(f"✅ Found {len(unique_requests)} unique Follow-up endpoints.")
    ...
    if report_data:
        ...
        print(f"\n📊 Follow-ups report saved to: {REPORT_FILE}")
